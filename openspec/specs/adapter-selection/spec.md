...
Provide a configurable mechanism for selecting which implementation adapter (Claude Code, Codex, etc.) will be used to execute tasks. Allows operators to specify adapter preferences and control fallback behavior when preferred adapters are unavailable.
