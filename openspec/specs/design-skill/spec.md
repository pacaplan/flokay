...
The `flokay:design` skill conducts architecture-focused conversations that identify and resolve technical trade-offs and design patterns. It reads completed specs as input, surfaces spec implications as architectural decisions emerge, and edits spec files to complete deferred scenarios and add architecture-driven insights.
