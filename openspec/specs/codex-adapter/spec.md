...
Implement an adapter that dispatches tasks to OpenAI Codex for execution. This adapter encapsulates Codex SDK interaction, progress streaming, token usage reporting, and failure handling.
